...
mydat <- read.csv(file = "Data/hapo_metabolomics_2019.csv")
...
## ---- Slide 26: message = FALSE, eval=TRUE,tidy=TRUE, tidy.opts=list(width.cutoff=80)----
...
## ---- Slide 27: message = FALSE, eval=TRUE,tidy=TRUE, tidy.opts=list(width.cutoff=80), fig.align='center'----
### Visualizing network 
...
## ---- Slide 30: message = TRUE, eval=TRUE,tidy=TRUE, tidy.opts=list(width.cutoff=80)----

### Visualizing network with node groups 
mylist <- list(c("mt1_1","mt1_2"), c("mt2_1","mt2_2"), c("mt3_1","mt3_2"))


## ---- Slide 31: message = TRUE, eval=TRUE, fig.align='center'----------------------
plot.igraph(igraph.obj,vertex.label=colnames(adj.1),layout=layout.fruchterman.reingold, mark.groups=mylist)


## ---- Slide 32: message = FALSE, eval=FALSE,tidy=TRUE, tidy.opts=list(width.cutoff=80), fig.align='center'----
## 
...
## ---- Slide 35: message = FALSE, eval=TRUE,tidy=TRUE, tidy.opts=list(width.cutoff=80)----
...
## ---- Slide 38: message = FALSE, eval=TRUE,tidy=TRUE, tidy.opts=list(width.cutoff=80)----
...
## ---- Slide 39: message = FALSE, eval=TRUE,tidy=TRUE, tidy.opts=list(width.cutoff=80)----
...
## ---- Slide 40: eval=TRUE,tidy=TRUE, tidy.opts=list(width.cutoff=80), fig.align='center', echo=TRUE----
### Visualizing network 
